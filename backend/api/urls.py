...
urlpatterns = [
    ...
    path('live-stream/go-live/', LiveStreamGoLiveView.as_view(), name='live_stream_go_live'),
    path('live-stream/end/', LiveStreamEndView.as_view(), name='live_stream_end'),
